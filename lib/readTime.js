...
class readTime {
    ...
    /**
     * @function imgCounter
     * @desc count number of image tags in the HTML, markdown text, and HEXO image tags
     * @private
     */
    imgCounter() {

        // This regex will match image tags in HTML, Markdown, and the HEXO tags `{% img [...] %}`, `{% image [...] %}`, and `{% inlineimage [...] %}` tags.
    ...
    calculate() {
        ...
        // add word (in minutes) with img times (in seconds)
